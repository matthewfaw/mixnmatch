...
SPLIT_KEY=country
TARGET=price
COLS_TO_DROP="Other,price_quartile"
# Value counts
#{'US': 54265,
# 'Spain': 6573,
# 'France': 17776,
...
# 'Turkey': 90,
# 'Bulgaria': 141}
VAL_TRAIN_VAL_TEST="US:1.0,0.0,0.0,0.0|France:1.0,0.0,0.0,0.0|Italy:1.0,0.0,0.0,0.0|Spain:1.0,0.0,0.0,0.0|Chile:0.0,0.05,0.95,0.0|Australia:0.0,0.05,0.95,0.0"
