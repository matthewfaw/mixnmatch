...
# 'Turkey': 90,
# 'Bulgaria': 141}
VAL_TRAIN_VAL_TEST="South Africa:1.0,0.0,0.0,0.0|Germany:1.0,0.0,0.0,0.0|Spain:1.0,0.0,0.0,0.0|Chile:1.0,0.0,0.0,0.0|Argentina:1.0,0.0,0.0,0.0|France:0.0,0.5,0.5,0.0"
TAG=latest
