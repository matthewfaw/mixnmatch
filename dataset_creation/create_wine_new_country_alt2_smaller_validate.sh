...
# 'Turkey': 90,
# 'Bulgaria': 141}
VAL_TRAIN_VAL_TEST="US:1.0,0.0,0.0,0.0|France:1.0,0.0,0.0,0.0|Italy:1.0,0.0,0.0,0.0|Spain:1.0,0.0,0.0,0.0|Chile:0.0,0.005,0.995,0.0"
TAG=latest
SIZE=new-country-alt2-smaller-val
