...
COLS_TO_CENSOR="record_type,group_size,risk_factor,car_age,cost_avg,car_value_e,car_value_f,C_previous,location,A_changes,B_changes,C_changes,D_changes,E_changes,F_changes,G_changes,age_oldest,age_youngest"
