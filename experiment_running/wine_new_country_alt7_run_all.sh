...
ID=wine
FILE="wine_country_price_US:1.0,0.0,0.0,0.0|France:1.0,0.0,0.0,0.0|Italy:1.0,0.0,0.0,0.0|Spain:1.0,0.0,0.0,0.0|Australia:0.0,0.05,0.95,0.0_latest.p"
OPT_MULT=500
