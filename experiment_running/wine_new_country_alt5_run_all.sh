...
ID=wine
FILE="wine_country_price_US:1.0,0.0,0.0,0.0|France:1.0,0.0,0.0,0.0|Italy:1.0,0.0,0.0,0.0|Spain:1.0,0.0,0.0,0.0|Portugal:0.0,0.01,0.99,0.0_latest.p"
OPT_MULT=500
